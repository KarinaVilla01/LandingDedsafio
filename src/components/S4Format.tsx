        ...
        <section id="format" className="pt-5 relative py-20 px-4 text-white overflow-hidden">
            <div className="max-w-7xl mx-auto flex lg:flex-row items-center gap-12 columnCel">
                ...
                <div className="flex-1 flex justify-center">
                    <img src="/LandingDedsafio/imgs/Formato/MegaBlaziken.png" alt="Personajes" className="with70" />
                </div>
                ...
                <div className="flex-1 space-y-4 text-left">
                    <div className="marginCenter">
                        <div className="aboutLetters">
                            <img src="/LandingDedsafio/imgs/Formato/formato.png" alt="" />
                        </div>
                        ...
                        <a href='/LandingDedsafio/format' className="btn-grad3 mt-4">
